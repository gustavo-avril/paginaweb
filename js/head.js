...
`;
// Paola Aguirre
document.getElementById("head-lit").innerHTML = `
<div class="head d-block">
  <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
    <div class="mainflip">
      <div class="frontside">
        <div class="card">
          <div class="card-body">
            <p class="inner">
              <img src="./images/organigrama/paolaA.webp" alt="Paola Aguirre" class="inner-image">
            </p>
            <div class="contenido">
              <p class="nombre">Paola Aguirre</p>
              <p class="cargo">Head of Commercial & Business - Litoral</p>
            </div>
          </div>
        </div>
      </div>
      <div class="backside">
        ...
        <div class="card">
          <div class="card-body comercial">
            <div class="mb-2">
              <p class="titulo text-center">Head of Commercial & Business - Litoral</p>
            </div>
            <div>
              <p class="text-center"><i class="ti-email"></i></p>
